        ...
        <div class="row">
            ...
            if (isset($_SESSION["u"])) {
                ...
                $details_rs = Database::search("SELECT * FROM `user` 
                    INNER JOIN `gender` ON `user`.`gender_gender_id`=`gender`.`gender_id`
                    WHERE `email` = '" . $email . "'
                    ");
                ...
                $image_detials = $image_rs->fetch_assoc();
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-3 border-end">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        ...
                                        if (empty($image_detials["path"])) {
                                            ?>
                                            <img src="resource/new_user.svg" class="rounded mt-5" style="width: 150px;" id="img" />
                                            <?php
                                        } else {
                                            ?>
                                            <img id="img" src="<?php echo $image_detials["path"]; ?>" class="rounded mt-5"
                                                style="width: 150px;" />
                                            <?php
                                        }
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" 
                                                    value="<?php echo $user_details["fname"]; ?>" id="fname"/>
                                            </div>

                                            <div class="col-6">
                                                <label class="form-label">Last Name</label>
                                                <input type="text" class="form-control"
                                                    value="<?php echo $user_details["lname"]; ?>" id="lname"/>
                                            </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <?php
                                                    ...
                                                    if(empty($address_details["postal_code"])){
                                                        ...
                                                        ?>
                                                        <input type="text" class="form-control" value="<?php echo $address_details["postal_code"]?>" id="pcode"/>
                                                        <?php
                                                    }
