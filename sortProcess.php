                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    ...
                                                    <span class="card-text fw-bold text-primary"><?php echo $selected_data["price"];?>
                                                        .00</span><br />
                                                    ...
                                                    <div class="form-check form-switch">
                                                        ...
                                                        <label class="form-check-label fw-bold text-info"
                                                         ...
                                                         <?php if($selected_data["status_status_id"]==1){?> Make Your Product Deactive <?php }
                                                          else { ?>Make Your Product Active <?php }?></label>
                                                    </div>
