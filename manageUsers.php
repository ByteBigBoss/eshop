    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="offset-0 offset-lg-3 col-12 col-lg-6 mb-3">
                        <div class="row">
                            ...
                            <div class="col-3 d-grid">
                                <button type="button" class="btn btn-warning">Search User</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            ?>
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2" onclick="viewMsgModal('<?php echo $selected_data['email']; ?>');">
                            ...
                            ?>
                                <img width="70px" src="<?php echo ($img_data["path"]); ?>" />
                            <?php

                            } else {
                            ?>
                                <img width="70px" src="resource/male_boy_person_people_avatar_icon_159358.png" width="70px" />
                ...
                <!-- msg modal -->
                <div class="modal" tabindex="-1" id="userModal<?php echo $selected_data["email"]; ?>">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body " style="overflow-y: scroll; height:400px;" id="userChatBox<?php echo($selected_data["email"]); ?>">
