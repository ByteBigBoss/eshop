...
function basicSearch(x) {
    ...
    r.open("POST", "basicSsearchProcess.php", true);
    r.send(f);
}
...
function advancedSearch(x) {
    ...
    var price_f = document.getElementById("pf");
    var price_t = document.getElementById("pt");
    ...
    r.onreadystatechange = function () {
        if (r.readyState == 4) {
            ...
            if (t == "1") {
                ...
                var payment = {
                    "sandbox": true,
                    "merchant_id": "1221233",    // Replace your Merchant ID
...
function verify(){
    var varification = document.getElementById("vcode");
    ...
    r.open("GET","varificationProcess.php?v="+varification.value,true);
    r.send();
}
...
function viewMsgModal(email) {
    ...
    var m = document.getElementById("userModal" + email);
    mm = new bootstrap.Modal(m);
    mm.show();
    viewUserMessages(email);
}

function viewUserMessages(email2) {
    //alert(email2);
    var r = new XMLHttpRequest();
    r.onreadystatechange = function () {
        if (r.readyState == 4) {
            var t = r.responseText;
            document.getElementById("userChatBox" + email2).innerHTML = t;
        }
    };
    r.open("GET", "viewUserMessage.php?f=" + email2, true);
    r.send();
}
...
function sendText(email) {
    ...
    r.open("POST", "sendTextProcess.php", true);
    r.send(f);
}
...
function sendAdminMsg1() {
    ...
    r.open("POST", "sendAdminMesssage.php", true);
    r.send(f);
}
...
function sendAdminMsg(email) {
    ...
    var txt = document.getElementById("msgtxt" + email);
    //alert(txt.value)
    var f = new FormData();
    f.append("t", txt.value);
    f.append("r", email);
...
function viewAdminMessages() {
    ...
    r.open("GET", "viewAdminMessage.php", true);
    r.send();
}