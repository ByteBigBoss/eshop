                            ...
                            <div class="row border border-primary">
                                ...
                                <div class="col-12">
                                    <div class="row justify-content-center gap-2">
                                        ...
                                        $product_rs = Database::search("SELECT * FROM `product` WHERE `category_cat_id`='" . $category_data2["cat_id"] . "' AND
                                     `status_status_id`='1' ORDER BY `datetime_added` DESC LIMIT 4 OFFSET 0");
                                        ...
                                        for ($z = 0; $z < $product_num; $z++) {
                                            ...
                                            <div class="card col-6 col-lg-2 mt-2 mb-2" style="width: 18rem;">
                                                ...
                                                <?php
                                                $img_rsl = Database::search("SELECT * FROM `product_img` WHERE `product_id`='" . $product_data["id"] . "'");
                                                ...
                                                <div class="card-body ms-0 m-0 text-center">
                                                    ...
                                                    if ($product_data["qty"] > 0) {
                                                        ...
                                                        <span class="card-text text-success fw-bold">
                                                            <?php echo $product_data["qty"] ?> Items
                                                            Available
                                                        </span><br /><br />
