                        ...
                        <div class="col-12 px-2">
                            <div class="row">
                                <div class="input-group mb-3 ">
                                    <input type="text" id="text" class="form-control rounded border-0 py-3 bg-light" placeholder="Type a message ..." aria-describedby="send_btn">
                                 
                                    <button onclick="sendText('<?php echo $msg_data2['to']; ?>');" class="btn btn-light fs-2" id="send_btn"><i class="bi bi-send-fill fs-1"></i></button>
                                </div>
                            </div>
                        </div>
                        <!-- txt -->
