        ...
        <div class="offset-lg-1 col-12 col-lg-3">
          <div class="row">
            ...
            <div class="card col-6 col-lg-2 mt-2 mb-2" style="width: 18rem;">
              ...
              <?php
              $img_rsl = Database::search("SELECT * FROM `product_img` WHERE `product_id`='" . $selected_data["id"] . "'");
              $img_data = $img_rs->fetch_assoc();

              ?>

              <img src="<?php echo $img_data["img_path"] ?>" class="card-img-top img-thumbnail mt-2"
                style="height: 180px;" />
              <div class="card-body ms-0 m-0 text-center">
                ...
                if ($selected_data["qty"] > 0) {
                  ...
                  <span class="card-text text-success fw-bold">
                    <?php echo $selected_data["qty"] ?> Items
                    Available
                  </span><br /><br />
