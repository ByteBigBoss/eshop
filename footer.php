        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    ...
                    <p>Here we are the eShop.lk&trade; to support you accomplish your dessire by selling high quality products</p>
                </div>
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-envelope-open-fill"></i> eshop@gmail.com</p>
