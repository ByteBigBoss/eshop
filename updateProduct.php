        ...
        <div class="row gy-3">
            ...
            if (isset($_SESSION["u"])) {
                ...
                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 border-end border-success">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="u" name="c" checked
                                                         disabled />
                                                    <label class="form-check-label fw-bold" for="u">Used</label>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <textarea cols="30" rows="15" class="form-control"
                                            id="d"><?php echo $product["description"]?></textarea>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="offset-lg-3 col-12 col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-4 border border-primary rounded">
                                                <img id="i0" src="<?php echo $img[0];?>" class="img-fluid"
                                                    style="width: 250px;" />
                                            </div>
                                            <div class="col-4 border border-primary rounded">
                                                <img id="i1" src="<?php echo $img[0];?>" class="img-fluid"
                                                    style="width: 250px;" />
                                            </div>
                                            <div class="col-4 border border-primary rounded">
                                                <img id="i2" src="<?php echo $img[0];?>" class="img-fluid"
                                                    style="width: 250px;" />
                                            </div>
                                        </div>
                                    </div>
                    ...
                    ?>
                    <script>
                        alert("Please selectt a product to update.");
