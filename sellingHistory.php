...
<head>
    ...
    <title>Selling History | Admin | eShop</title>
            ...
            <div class="col-12 mt-2" id="viewArea">
                ...
                <div class="row">
                    ...
                    ?>
                        ...
                        <div class="col-1 bg-secondary text-end">
                            <label class="form-label fs-5 fw-bold text-white mt-2"><?php echo ($selected_data["id"]); ?></label>
                        </div>
                        <div class="col-3 bg-body text-end">
                        ...
                        <div class="col-2 bg-body text-end">
                            <label class="form-label fs-5 fw-bold text-black mt-2"><?php echo ($selected_data["total"]); ?></label>
                        </div>
                        <div class="col-1 bg-secondary text-end">
                            <label class="form-label fs-5 fw-bold text-black mt-2"><?php echo ($selected_data["qty"]); ?></label>
                        </div>
                        <div class="col-2 bg-white d-grid">
                            ...
                            ?>
                                <button class="btn btn-success fw-bold mt-1 mb-1" onclick='changeStatus("<?php echo($selected_data["id"]); ?>");' 
                                id="btn<?php echo($selected_data["id"]); ?>">Confirm Order</button>

                            <?php
                            } else if ($selected_data["status"] == 1) {
                            ?>
                                <button class="btn btn-warning fw-bold mt-1 mb-1"onclick='changeStatus("<?php echo($selected_data["id"]); ?>");' 
                                id="btn<?php echo($selected_data["id"]); ?>">Packing</button>

                            <?php
                            } else if ($selected_data["status"] == 2) {
                            ?>
                                <button class="btn btn-info fw-bold mt-1 mb-1" onclick='changeStatus("<?php echo($selected_data["id"]); ?>");' 
                                id="btn<?php echo($selected_data["id"]); ?>">Dispacth</button>

                            <?php
                            } else if ($selected_data["status"] == 3) {
                            ?>
                                <button class="btn btn-primary fw-bold mt-1 mb-1" onclick='changeStatus("<?php echo($selected_data["id"]); ?>");' 
                                id="btn<?php echo($selected_data["id"]); ?>">Shipping</button>

                            <?php
                            } else if ($selected_data["status"] == 4) {
                                ?>
                                <button class="btn btn-danger fw-bold mt-1 mb-1" onclick='changeStatus("<?php echo($selected_data["id"]); ?>");' 
                                id="btn<?php echo($selected_data["id"]); ?>" disabled>Delivered</button>
